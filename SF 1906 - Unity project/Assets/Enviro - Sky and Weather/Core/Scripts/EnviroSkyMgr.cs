...
#if ENVIRO_HD && ENVIRO_LW
            if (currentEnviroSkyVersion == EnviroSkyVersion.HD)
                return EnviroSky.instance.HDR;
            else
                return EnviroSkyLite.instance.HDR;
#elif ENVIRO_HD
        return EnviroSky.instance.HDR;
#elif ENVIRO_LW
        return EnviroSkyLite.instance.HDR;
...
#if ENVIRO_HD && ENVIRO_LW
            if (currentEnviroSkyVersion == EnviroSkyVersion.HD)
                EnviroSky.instance.HDR = value;
            else
                EnviroSkyLite.instance.HDR = value;
#elif ENVIRO_HD
       EnviroSky.instance.HDR = value;
#elif ENVIRO_LW
       EnviroSkyLite.instance.HDR = value;
