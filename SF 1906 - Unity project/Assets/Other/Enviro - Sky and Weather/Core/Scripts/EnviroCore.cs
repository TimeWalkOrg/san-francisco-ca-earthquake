...
public class EnviroCore : MonoBehaviour
{
    ...
    public void CalculateDirectLight()
    {
        ...
        if (lightSettings.directionalLightMode == EnviroLightSettings.LightingMode.Single || Components.AdditionalDirectLight == null)
        {
...
#if ENVIRO_HDRP
                lightIntensity = lightSettings.directLightSunIntensity.Evaluate(GameTime.solarTime) * lightSettings.lightExposure * 500f;
#else
            ...
            {
#if ENVIRO_HDRP
                lightIntensity = lightSettings.directLightMoonIntensity.Evaluate(GameTime.lunarTime) * lightSettings.lightExposure * 500f;
#else
