...
public class EnviroSky : EnviroCore
{
    ...
    public void CreateSkyAndFogVolume()
    {
        ...
        for (int i = 0; i < volume.Length; i++)
        {
            ...
            if (found == false && volume[i].sharedProfile != null && volume[i].sharedProfile.TryGet<UnityEngine.Rendering.HighDefinition.VisualEnvironment>(out TempEnv))
            {
    ...
    /// <summary>
    /// Creates a Sky and Fog Volume or modify an exisiting one.
    /// </summary>
