...
{
#if ENVIRO_HD
    private string latestVersion = "2.3.0";
    // GUI Styles 
    ...
    SerializedProperty Player, Camera, PlayerTag, CameraTag, AssignOnRuntime, HDR, SatTag, startMode, singlePassInstancedVR;
    ...
    SerializedProperty lightExposure, exposure, angleOffset, lightColorGradient, lightIntensityCurveSun, lightIntensityCurveMoon, shadowStrength, VolumeLightingResolution, globalReflectionsUpdateOnPosition, globalReflectionsUpdateOnGameTime;
    ...
    //HDRP
    SerializedProperty lightingUpdateEachFrames;
    ...
    void OnEnable()
    {
        ...
        lightExposure = serializedObj.FindProperty("lightSettings.lightExposure");
            ...
            if (myTarget.showSettings)
            {
                ...
                switch (myTarget.profile.viewMode)
                {
                    case EnviroProfile.settingsMode.Lighting:
                        ...
                        EditorGUILayout.PropertyField(lightExposure, true, null);
